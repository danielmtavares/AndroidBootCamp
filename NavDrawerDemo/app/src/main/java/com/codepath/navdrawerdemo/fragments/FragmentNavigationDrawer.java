package com.codepath.navdrawerdemo.fragments;
...
import com.codepath.navdrawerdemo.adapters.NavDrawerListAdapter;
...
public class FragmentNavigationDrawer extends DrawerLayout {
    ...
    public void selectDrawerItem(int position) {
        ...
        fragmentManager.beginTransaction().replace(this.drawerContainerRes, fragment).commit();
    ...
    private ActionBarDrawerToggle setupDrawerToggle() {
        return new ActionBarDrawerToggle(getActivity(), this, toolbar, R.string.app_name,
                R.string.app_name);
    }
